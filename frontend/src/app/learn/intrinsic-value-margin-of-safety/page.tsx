    ...
    <div className="min-h-screen bg-brand-bg">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <article className="bg-brand-card rounded-xl border border-brand-border p-8 space-y-6">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">What is intrinsic value?</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">What is the margin of safety?</h2>
            <p className="text-sm text-brand-fg/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">The Graham Number — a simple way to estimate intrinsic value</h2>
            <p className="text-sm text-brand-fg/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">A worked example</h2>
            <p className="text-sm text-brand-fg/70 leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-brand-bg border border-brand-border space-y-1">
              <p className="text-sm text-brand-fg font-mono">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">How to read the result</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">When the Graham Number does not work</h2>
            <ul className="text-sm text-brand-fg/70 leading-relaxed list-disc pl-5 space-y-1">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">Other ways to estimate intrinsic value</h2>
            <ul className="text-sm text-brand-fg/70 leading-relaxed list-disc pl-5 space-y-1">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">Why margin of safety matters more than the formula</h2>
            <p className="text-sm text-brand-fg/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">Check any PSX stock&apos;s value in one click</h2>
            <p className="text-sm text-brand-fg/70 leading-relaxed">
