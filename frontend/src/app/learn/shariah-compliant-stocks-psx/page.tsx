    ...
    <div className="min-h-screen bg-[#F8F3EA]">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <article className="bg-white rounded-xl border border-[#E5E0D9] p-8 space-y-6">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-[#404E3F]">What is the KMI-30 Index?</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-[#404E3F]">KMI-30 vs KMI All Shares Index</h2>
            <p className="text-sm text-[#404E3F]/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-[#404E3F]">The two-part Shariah screening</h2>
            <p className="text-sm text-[#404E3F]/70 leading-relaxed">
              To be called Shariah-compliant, a PSX company has to pass two types of checks:
            </p>
            <ol className="text-sm text-[#404E3F]/70 leading-relaxed list-decimal pl-5 space-y-1">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-[#404E3F]">1. Business activity screening</h2>
            <p className="text-sm text-[#404E3F]/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-[#404E3F]">2. Financial ratio screening</h2>
            <p className="text-sm text-[#404E3F]/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-[#404E3F]">What about small non-compliant income?</h2>
            <p className="text-sm text-[#404E3F]/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-[#404E3F]">How often is the list reviewed?</h2>
            <p className="text-sm text-[#404E3F]/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-[#404E3F]">How to invest Islamically on PSX</h2>
            <ul className="text-sm text-[#404E3F]/70 leading-relaxed list-disc pl-5 space-y-1">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-[#404E3F]">Check Shariah status in one click</h2>
            <p className="text-sm text-[#404E3F]/70 leading-relaxed">
      ...
      <footer className="border-t border-[#E5E0D9] mt-16 py-6">
        <div className="max-w-3xl mx-auto px-4 text-center space-y-2">
          <p className="text-xs text-[#404E3F]/40">For educational purposes only. Not financial advice.</p>
