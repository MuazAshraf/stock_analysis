    ...
    <div className="min-h-screen bg-brand-bg">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <article className="bg-brand-card rounded-xl border border-brand-border p-8 space-y-6">
          ...
          <p className="text-xs text-brand-fg/50">Updated April 2026 · 8 min read</p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">What is the Pakistan Stock Exchange?</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">Step 1 — Choose a broker</h2>
            <p className="text-sm text-brand-fg/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">Step 2 — Open a CDC sub-account</h2>
            <p className="text-sm text-brand-fg/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">Step 3 — Fund your account</h2>
            <p className="text-sm text-brand-fg/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">Step 4 — Buy your first share</h2>
            <p className="text-sm text-brand-fg/70 leading-relaxed">
              Log into your broker&apos;s trading app. Search for a company by its PSX symbol (for example <code className="px-1 rounded bg-brand-bg text-brand-fg">LUCK</code> for Lucky Cement or <code className="px-1 rounded bg-brand-bg text-brand-fg">OGDC</code> for Oil and Gas Development Company). Enter the number of shares you want to buy and the price you are willing to pay, then place the order.
            </p>
            <p className="text-sm text-brand-fg/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">Step 5 — Research before you buy</h2>
            <p className="text-sm text-brand-fg/70 leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">Taxes and charges to expect</h2>
            <ul className="text-sm text-brand-fg/70 leading-relaxed list-disc pl-5 space-y-1">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-brand-fg">Common mistakes beginners make</h2>
            <ul className="text-sm text-brand-fg/70 leading-relaxed list-disc pl-5 space-y-1">
