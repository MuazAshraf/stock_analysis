...
const GLOSSARY = [
  ...
  { term: "Book Value", en: "If the company sold everything and paid off all debts, what's left per share. If stock price is below book value, some investors consider it undervalued.", ur: "Agar company sab kuch bech de aur saare qarz chuka de, toh har share ke hisse mein kya bachega. Agar stock price book value se kam hai toh kuch investors isko sasta maante hain." },
...
const FORMULAS = [
  { title: "Book Value Per Share", formula: "(Total Assets - Total Liabilities) / Total Shares", en: { explanation: "Imagine the company sold everything it owns and paid off all debts. Whatever is left, divided by total shares, is the book value. If the stock price is below this number, it might be undervalued.", example: "If a company has Rs. 500Cr in assets, Rs. 200Cr in debts, and 10Cr shares: (500 - 200) / 10 = Rs. 30 per share" }, ur: { explanation: "Socho company ne sab kuch bech diya aur saare qarz chuka diye. Jo bacha woh total shares pe divide karo — ye book value hai. Agar stock price is se kam hai toh sasta ho sakta hai.", example: "Company ke paas Rs. 500Cr assets, Rs. 200Cr qarz, aur 10Cr shares: (500 - 200) / 10 = Rs. 30 per share" } },
